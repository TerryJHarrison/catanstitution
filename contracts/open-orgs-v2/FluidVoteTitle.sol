...
contract FluidVoteTitle is SingleHolderTitle {
    ...
    constructor (string memory _title, string memory _titleAbbreviation, address _holder, VoterPool _voters, address _titleOperator) {
        SingleHolderTitle.initialize(_title, _titleAbbreviation, _holder, _titleOperator);
        voters = _voters;
    }
